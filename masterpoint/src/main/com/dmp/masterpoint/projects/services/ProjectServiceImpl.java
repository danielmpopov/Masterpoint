...
import com.dmp.masterpoint.projects.models.binding.TaskAddBindingModel;
import com.dmp.masterpoint.projects.models.view.*;
import com.dmp.masterpoint.projects.repositories.ProjectRepository;
...
import com.dmp.masterpoint.users.services.UserService;
import com.dmp.masterpoint.users.services.WorkmanService;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Override
    public void add(ProjectAddBindingModel projectBindingModel, String username) {
    ...
    public List<ProjectSummaryViewModel> findMyProjects(String userName) {
        List<Project> allProjects = this.repository.findAllByClientName(userName);
