...
import com.dmp.masterpoint.repairworks.repositories.RepairWorkRepository;
...
public class RepairWorkServiceImpl implements RepairWorkService{
    ...
    public List<RepairWorkViewModel> findALLRepWorksByWorkman(String name) {
        List<RepairWork> allRepWorksByWorkman = this.repairWorkRepository.findALLRepWorksByWorkman(name);

        return this.repairWorkRepository.findALLRepWorksByWorkman(name)
                .stream()
    ...
    @Override
    public void add(RepairWorkBindingModel repairWorkBindingModel, String workmanName, String subCategoryName) {
        ...
        this.repairWorkRepository.save(repairWork);
    }
